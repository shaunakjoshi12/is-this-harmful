...
#do
CUDA_VISIBLE_DEVICES=0 python ../tools/train.py ../configs/is-this-harmful/refined/slowfast_swe_trailers_class_balanced_refined_benchmark.py --work-dir work_dirs/refined_train_video/slowfast_swe_trailers_class_balanced_refined_benchmark
